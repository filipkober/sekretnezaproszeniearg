...
const LEVEL_NAME: &str = "DEATHCAMP";
const LEVEL_NUM: usize = 13;
const ANS: &str = "33";
const HINT1: &str = "16";
const HINT2: &str = "przekonwertuj na ascii i rozwiąż";
    ...
    loop {
        terminal
            .draw(|f| {
                ...
                let mut text = vec![
                    Spans::from("37 78 5E 32 2D 34 36 32 78 2B 37 36 32 33 3D 30"),
                    Spans::from(""),
                ];
