...
const LEVEL_NAME: &str = "Today";
const LEVEL_NUM: usize = 17;
const ANS: &str = "46863";
const HINT1: &str = "wpisz jakiś numer i naciśnij [?]";
const HINT2: &str = "strzałka w górę oznacza że liczba jest za mała, strzałka w dół że za duża";
    ...
    loop {
        terminal
            .draw(|f| {
                ...
                let mut text = vec![
                    Spans::from("https://entr0py.nigdit.men/dzisiaj"),
                    Spans::from(""),
                ];
