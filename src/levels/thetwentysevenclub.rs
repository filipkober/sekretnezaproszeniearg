...
const LEVEL_NAME: &str = "The 27 Club";
const LEVEL_NUM: usize = 15;
const ANS: &str = "1982";
const HINT1: &str = "symbol krzyża często coś oznacza w kontekście ludzi...";
const HINT2: &str = "y, m, d - skróty angielskich słów";
    ...
    loop {
        terminal
            .draw(|f| {
                ...
                let mut text = vec![
                    Spans::from("Jimi Hendrix y† + Kurt Cobain d† + Amy Winehouse m†"),
                    Spans::from(""),
                ];
