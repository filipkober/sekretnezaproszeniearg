...
const LEVEL_NAME: &str = "Free The Frail";
const LEVEL_NUM: usize = 16;
const ANS: &str = "781";
const HINT1: &str = "czemu OPTIONS jest napisane wielkimi literami?";
const HINT2: &str = "po wykonaniu zapytania, zwróć uwagę na wielkość liter";
    ...
    loop {
        terminal
            .draw(|f| {
                ...
                let mut text = vec![
                    Spans::from("OPTIONS https://entr0py.nigdit.men/ftfrl"),
                    Spans::from(""),
                ];
