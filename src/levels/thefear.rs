...
const LEVEL_NAME: &str = "The Fear";
const LEVEL_NUM: usize = 11;
const ANS: &str = "347294";
const HINT1: &str = "hmm, trochę tu pusto, strona chyba wymaga INSPEKCJI";
const HINT2: &str = "spojrzałbym na inputy";
    ...
    loop {
        terminal
            .draw(|f| {
                ...
                let mut text = vec![
                    Spans::from("https://entr0py.nigdit.men/f"),
                    Spans::from(""),
                ];
